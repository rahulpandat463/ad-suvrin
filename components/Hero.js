    ...
    <section className={`${styles.hero} grid-bg`}>
      ...
      <div className="container">
        <div className={styles.inner}>
          ...
          <div className={styles.content}>
            ...
            <div className={styles.badgeRow}>
              <span className={styles.topBadge}>
                ...
                <span className={styles.badgeLong}>Dubai Marina Office</span>
                <span className={styles.badgeShort}>Dubai Marina</span>
              </span>
              <span className={styles.topBadgeSecondary}>Odoo v17/v18</span>
              <span className={styles.topBadgeSecondary}>On-Site Audits</span>
            </div>

            {/* Headline */}
            <h1 className={styles.headline}>
              Manufacturing ERP for{' '}
            ...
            <div className={styles.subHeadlinePill}>
              ...
              <span>Connect Production, Multi-Warehouse Inventory &amp; UAE VAT</span>
            </div>

            {/* Body */}
            <p className={styles.body}>
              Suvrin implements and customises Odoo ERP for UAE manufacturers — factory routing, finite capacity, scrap control, and bilingual VAT compliance across Dubai, Sharjah &amp; Abu Dhabi.
            </p>

            {/* CTAs */}
            <div className={styles.ctas}>
              <a href="#consultation-form" className={`btn-primary ${styles.ctaPrimary}`}>
              ...
              <a
                ...
                className={`btn-whatsapp ${styles.ctaWa}`}
              >
            ...
            {/* Direct line */}
            <a href="tel:+971551120975" className={styles.directLineCard}>
              <svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="#0F3C7E" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
            ...
            <div className={styles.badges}>
              {TRUST_BADGES.map((b) => (
                <span key={b.label} className={styles.trustBadge}>
                  <svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="#0284C7" strokeWidth="2.5">
          ...
          {/* Right — Live Dashboard Mockup (hidden on small mobile) */}
          <div className={styles.dashboardWrap}>
            ...
            <div className={styles.dashboard}>
              ...
              {/* Divider label */}
              <div className={styles.sectionLabel}>SHOP FLOOR — REAL-TIME</div>

              {/* Work Centers */}
              <div className={styles.workCenters}>
                {[
                  { name: 'WC-01 CNC Milling', mo: 'MO-089 (Aluminum)', pct: 92, color: '#059669' },
                  { name: 'WC-02 Laser Cutting', mo: 'MO-094 (Steel)', pct: 64, color: '#0F3C7E' },
                  { name: 'WC-03 Powder Coat', mo: 'Batch #881', pct: 45, color: '#0284C7' },
                ].map((wc) => (
