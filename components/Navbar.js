    ...
    <nav className={`${styles.nav} ${scrolled ? styles.navScrolled : ''}`}>
      <div className={`container ${styles.inner}`}>
        ...
        <ul className={styles.navLinks}>
          <li><a href="#pain-points">Problems</a></li>
          ...
          <li><a href="#uae-localization-section">UAE Compliance</a></li>
        </ul>
      ...
      {menuOpen && (
        <div className={styles.mobileMenu}>
          <a href="#pain-points" onClick={() => setMenuOpen(false)}>Problems</a>
          <a href="#workflow-section" onClick={() => setMenuOpen(false)}>Workflow</a>
          <a href="#modules-section" onClick={() => setMenuOpen(false)}>Modules</a>
          <a href="#industries-section" onClick={() => setMenuOpen(false)}>Industries</a>
          <a href="#uae-localization-section" onClick={() => setMenuOpen(false)}>UAE Compliance</a>
          <div className={styles.mobileCtas}>
            ...
            >WhatsApp Us</a>
            <a href="#consultation-form" className="btn-primary" onClick={() => setMenuOpen(false)}>Book Consultation</a>
          </div>
        </div>
      )}
    </nav>
